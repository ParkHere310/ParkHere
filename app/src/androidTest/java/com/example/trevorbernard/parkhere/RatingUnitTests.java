...
public class RatingUnitTests {
    ...
    @Test
    public void UserRatingGood() throws Exception {
        ...
        for(User user : users) {
            assertTrue("User rating is between 0 and 5", user.getRating().calculateRating() >= 0 &&
            user.getRating().calculateRating() <= 5);
        }
    }

    @Test
    public void PSRatingGood() throws Exception {
                    ...
                    queryRef2.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                                ...
                                if(spot.getRating() != null) spots.add(spot);
                            }
                            done.add(0, true);
                        }
